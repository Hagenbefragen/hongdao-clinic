...
const translations = {
  ...
  de: {
        ...
        "reise.hero_dates": "10. � 20. Oktober 2026 | 10 Tage, 10 N�chte",
        "reise.overview_title": "Teil 1: TCM-Intensivausbildung in Shenzhen",
        "reise.overview_desc": "In diesen f�nf Tagen werden Meister Xu Ruqi und sein Team uns durch eine Balance aus TCM-Theorie und Praxis f�hren. Sie lernen die Prinzipien der TCM aus einer kulturellen, medizinischen und historischen spirituellen Perspektive kennen und beobachten gleichzeitig Live-Patientenbehandlungen in seinem neu er�ffneten Krankenhaus im Herzen der Stadt.",
        "reise.wudang_title": "Teil 2: Integration in das heilige Landleben Chinas",
        "reise.wudang_desc": "Am 15. Oktober reisen wir in die Wudang-Berge, eine legend�re daoistische Landschaft. Wir wohnen in der l�ndlichen Privatresidenz des daoistischen Priesters Yin Chen Zi und seiner Frau Li Xin, teilen biologische, hausgemachte Mahlzeiten und das t�gliche Leben in enger Verbundenheit mit dem Land.",
        "reise.itinerary_title": "Der Reiseablauf",
        "reise.day_arrival": "09. Oktober | Ankunftstag",
        "reise.day_arrival_desc": "Ankunft in Shenzhen & Check-in im Hotel Qianhai Gongyu. Einzelzimmer f�r jeden Teilnehmer. Gemeinsames Abendessen.",
        "reise.day_prep": "10. Oktober | Willkommen & Vorbereitung",
        "reise.day_prep_desc": "Orientierung & Gruppen-Einf�hrung. Er�ffnungsmeditation und Klangsession. Individuelle Pulsdiagnose durch Meister Xu f�r jeden Teilnehmer mit personalisierten Kr�uterrezepturen.",
        "reise.day_tcm": "10. � 14. Oktober | TCM-Intensivtraining",
        "reise.day_tcm_desc": "4 Tage intensives Lernen & �ben. Kernthemen: Historische Einblicke, Puls- & Zungendiagnostik, Yin-Yang-Theorie sowie Live-Beobachtungen von Patientenbehandlungen.",
        "reise.day_wudang": "15. � 20. Oktober | Integration in den Wudang-Bergen",
        "reise.day_wudang_desc": "Reise nach Wudang. Leben an der urspr�nglichen Quelle des Qi. Ausfl�ge zu kulturellen St�tten, daoistischen Tempeln, Teezeremonien und optionale Behandlungen (Moxa, Schr�pfen, Gua Sha).",
        "reise.pricing_title": "Preise & Zahlungspl�ne",
        "reise.pricing_subtitle": "W�hle den passenden Plan f�r deine Reise",
        "reise.price_earlybird": "Fr�hbucher",
        "reise.price_earlybird_desc": "G�ltig bis 31. Mai",
        "booking.popular": "Am beliebtesten",
        "reise.price_standard": "Standard-Preis",
        "reise.price_standard_desc": "Regul�rer Buchungstarif",
        "reise.price_couple": "Paar-Angebot",
        "reise.price_couple_desc": "F�r zwei Teilnehmer",
        "booking.contact_us": "Jetzt Kontakt aufnehmen",
        "reise.inclusions": "Inklusive: Unterkunft, Verpflegung, Unterricht, Inlandszug nach Wudang. <br>Exklusive: Internationale Fl�ge & Visum.",
